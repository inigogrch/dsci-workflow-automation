...
#| echo: false
income <- read_csv("../data/raw/adult.csv")
...
#| echo: false
income_clean <- read_csv("../data/clean/adult_cleaned.csv")
...
knitr::kable(income_training_final)knitr::kable(income_training_final)
```
...
![Confusion Matrix of Full Model on Testing Set](../results/final/confusion.png){#fig-confusion-plot}
